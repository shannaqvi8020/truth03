...
class TruthScriptApp:
    ...
    def _update_progress(self, value, message):
        ...
        self.root.after(0, lambda: self._apply_progress(value, message))
    ...
    def _run_transcription(self):
        ...
        try:
            ...
            if result.get('success'):
                self._update_progress(0.90, "Saving output files...")
